...
* Challenge: develop a Monte Carlo simulation to demonstrate that the procedure being used to calculate the 93% confidence interval has the appropriate coverage rate.
